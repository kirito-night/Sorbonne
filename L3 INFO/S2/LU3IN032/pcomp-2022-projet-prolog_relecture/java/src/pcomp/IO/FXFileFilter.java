...
public class FXFileFilter extends FileFilter {
...
//  private static String HIDDEN_FILE                = "Hidden File";
   ...
   * Example: new FXFileFilter("jpg");
   * 
   * @see #addExtension
   */
  public FXFileFilter(String extension) {
      this(extension, null);
  }

  /**
   * Creates a file filter that accepts the given file type. Example: new
   * FXFileFilter("jpg", "JPEG Image Images");
   * 
   ...
   * @see #addExtension
   */
  public FXFileFilter(String extension, String description) {
      this();
      if (extension != null)
   ...
   * FXFileFilter(String {"gif", "jpg"});
   * 
   * Note that the "." before the extension is not needed adn will be ignored.
   * 
   * @see #addExtension
   */
  public FXFileFilter(String[] filters) {
      this(filters, null);
  }

  /**
   * Creates a file filter from the given string array and description.
   * Example: new FXFileFilter(String {"gif", "jpg"}, "Gif and JPG
   * Images");
   * 
   ...
   * @see #addExtension
   */
  public FXFileFilter(String[] filters, String description) {
      this();
   ...
   * 
   * FXFileFilter filter = new FXFileFilter();
